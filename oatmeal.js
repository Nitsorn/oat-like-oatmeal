...
$(document).ready(function(){
  ...
  function setUpNav(){
    ...
    if (window.innerWidth < 950) {
      if ($('.navigation').css('left') == '-250px' || !$('.navigation').hasClass('small')) {
  ...
  function toggleDropdown(target) {
    var titleHeight = target.find('.dropdown-title').height();
    var itemHeight = target.find('.dropdown-item').height();
